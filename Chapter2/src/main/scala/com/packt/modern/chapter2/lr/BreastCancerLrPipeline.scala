...
object BreastCancerLrPipeline extends WisconsinWrapper {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val predictionAndLabel: DataFrame = testDataPredictions.select("prediction", "label")


    val validatedRDD2: RDD[(Double, Double)] = predictionAndLabel.rdd.collect {
